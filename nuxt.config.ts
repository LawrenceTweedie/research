...
export default defineNuxtConfig({
  ...
  nitro: {
    ...
    prerender: {
      ...
      concurrency: 1, // Рендерить по 1 странице за раз для минимального потребления памяти
      // Интервал между страницами для сборки мусора
      interval: 0 // Без задержки между страницами
    }
  },
